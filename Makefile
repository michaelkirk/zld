...
build: fetch
	...
	xcodebuild ARCHS=arm64 ONLY_ACTIVE_ARCH=NO -project ld/zld.xcodeproj -scheme zld -derivedDataPath build -configuration Release build
...
abseil-cpp-20200225:
	...
	lipo -create $@/build/libabsl_arm64.a -output $@/build/libabsl.a
